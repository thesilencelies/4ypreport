...
\caption{Comparison of Agent learning for different hidden sizes with alternative hyper parameters and longer early stopping}
\label{fig:exp1rfo2}
\end{figure}
